...
/* -- Declarations of extern functions. -- */
 ...
 EXTERN_C_DECL void sine_DSRTInitMdl(
    void);

 EXTERN_C_DECL void sine_DSRTStartMdl(
    void);

 EXTERN_C_DECL void sine_DSRTStopMdl(
    void);
...
pApp->setIoResourceMap(ErrorList, &g_ResourceMap);
    sine_fcnModule_SIDRoot_TID0 = DsCFcnModule::create(ErrorList, pApp);
ApSimEngineOnInitIoPreRtosInit_ctlcBODY_2_VoltageOut(ErrorList, pApp);
...
ApSimEngineOnInitIoPostRtosInit_ctlcBODY_0_VoltageOut(ErrorList);
...
ApSimEngineOnStartIo_ctlcBODY_0_VoltageOut(ErrorList);
...
ApSimEngineOnStopIo_ctlcBODY_0_VoltageOut(ErrorList);
...
ApSimEngineRunTimeInit(
    DsTErrorList ErrorList, Int32 calledOnStart) 
{
ApSimEngineRunTimeInit_ctlcBODY_0_VoltageOut(ErrorList);
if (calledOnStart)
{
}
