...
BUILD_ERROR                    = [sprintf('DSRT MAKE ERROR: Make process failed for model sine.')]
SYS_TARGET_FILE                = any
PROJ_MARKER_FILE               = no
...
DS_PROTECTION                     = OFF
MW_MAKEFILE                       = sine.mk
MW_BUILDARGS                      =  MAT_FILE=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DTID01EQ=0"
...
# MW_COMPUTER                     = PCWIN64
MW_MODEL                          = sine
MW_MODEL_MODULES                  = sine_data.c sine_dsrtmdlfcn.c sine_dsrtmf.c sine_dsrttf.c sine_dsrtvdf.c
# MW_MODEL_MODULES_OBJ            = sine_data.obj sine_dsrtmdlfcn.obj sine_dsrtmf.obj sine_dsrttf.obj sine_dsrtvdf.obj 
MW_S_FUNCTIONS                    = 
# MW_S_FUNCTIONS_OBJ              = 
MW_S_FUNCTIONS_LIB                = 
# MW_SOLVER                       = 
...
MW_MODELREFS                      = 
MW_MODELREF_LINK_RSPFILE          = sine_ref.rsp
...
INTERFACE_LIB_$(LIB_BASENAME)_CC_SRC_FILES := sine.$(MW_TARGET_LANG_EXT) 
