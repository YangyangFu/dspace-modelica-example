...
model TwoZoneVAVUnitConverted
  ...
  UnitConversion.VoltageToUnit volToUni_yvav1(
    ...
    vol_max=10,
    y_min=0,
    y_max=1) annotation (Placement(transformation(extent={{-88,-70},{-68,-50}})));
...
equation
  ...
  connect(TDisVAV2.T, TDis2) annotation (Line(points={{-6,111},{-6,134},{170,
          134},{170,100},{190,100}}, color={0,0,127}));
  ...
  connect(yVAV2, volToUni_yvav2.vol)
    annotation (Line(points={{-120,60},{-90,60}}, color={0,0,127}));
  connect(volToUni_yvav2.y, vav2.yVAV) annotation (Line(points={{-67,60},{-60,
          60},{-60,68},{-44,68}}, color={0,0,127}));
  connect(yVAV1, volToUni_yvav1.vol)
    annotation (Line(points={{-120,-60},{-90,-60}}, color={0,0,127}));
  connect(volToUni_yvav1.y, vav1.yVAV) annotation (Line(points={{-67,-60},{-56,
          -60},{-56,-72},{-44,-72}}, color={0,0,127}));
  connect(VSup2.V_flow, vToCFM_vav2.V_flow)
    annotation (Line(points={{70,111},{70,110},{138,110}}, color={0,0,127}));
  connect(vToCFM_vav2.CFM, V2_flow) annotation (Line(points={{161,110},{166,110},
          {166,76},{190,76}}, color={0,0,127}));
  connect(VSup1.V_flow, vToCFM_vav1.V_flow)
    annotation (Line(points={{70,-29},{70,-20},{138,-20}}, color={0,0,127}));
  connect(vToCFM_vav1.CFM, V1_flow) annotation (Line(points={{161,-20},{172,-20},
          {172,-24},{190,-24}}, color={0,0,127}));
  annotation (Diagram(
