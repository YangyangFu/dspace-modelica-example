...
model FiveZoneG36Demo
  ...
  Modelica.Blocks.Interfaces.RealOutput TDisVAVCor
    "Temperature of the passing fluid"
    annotation (Placement(transformation(extent={{1350,292},{1370,312}})));
  Modelica.Blocks.Interfaces.RealOutput TDisVAVSou
    "Temperature of the passing fluid"
    annotation (Placement(transformation(extent={{1350,270},{1370,290}})));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanOutput ySupFan
    "Supply fan status, true if fan should be on"
    annotation (Placement(transformation(extent={{1302,582},{1342,622}})));
  Modelica.Blocks.Interfaces.RealOutput VDisVAVCor_flow
    "Volume flow rate from port_a to port_b"
    annotation (Placement(transformation(extent={{1358,190},{1378,210}})));
  Modelica.Blocks.Interfaces.RealOutput VDisVAVSou_flow
    "Volume flow rate from port_a to port_b"
    annotation (Placement(transformation(extent={{1348,170},{1368,190}})));
equation
  ...
  connect(TSupCor.T, TDisVAVCor) annotation (Line(points={{569,92},{538,92},{
          538,302},{1360,302}}, color={0,0,127}));
  connect(TSupSou.T, TDisVAVSou) annotation (Line(points={{749,92},{688,92},{
          688,224},{1340,224},{1340,280},{1360,280}}, color={0,0,127}));
  connect(conAHU.ySupFan, ySupFan) annotation (Line(points={{424,629.333},{1280,
          629.333},{1280,602},{1322,602}}, color={255,0,255}));
  connect(VSupCor_flow.V_flow, VDisVAVCor_flow) annotation (Line(points={{569,
          130},{550,130},{550,296},{1332,296},{1332,200},{1368,200}}, color={0,
          0,127}));
  connect(VSupSou_flow.V_flow, VDisVAVSou_flow) annotation (Line(points={{749,
          130},{742,130},{742,228},{1068,228},{1068,240},{1328,240},{1328,180},
          {1358,180}}, color={0,0,127}));
  connect(TZonSet[1].TZonCooSet, conAHU.TZonCooSet) annotation (Line(points={{82,317},
          {134,317},{134,631.111},{336,631.111}},         color={0,0,127}));
  connect(TZonSet[5].TZonCooSet, conVAVCor.TZonCooSet) annotation (Line(points=
          {{82,317},{524,317},{524,50},{528,50}}, color={0,0,127}));
  connect(TZonSet[1].TZonCooSet, conVAVSou.TZonCooSet) annotation (Line(points=
          {{82,317},{414,317},{414,316},{694,316},{694,48},{698,48}}, color={0,
          0,127}));
  connect(TZonSet[2].TZonCooSet, conVAVEas.TZonCooSet) annotation (Line(points=
          {{82,317},{396,317},{396,316},{872,316},{872,48},{878,48}}, color={0,
          0,127}));
  connect(conVAVNor.TZonCooSet, TZonSet[3].TZonCooSet) annotation (Line(points=
          {{1038,48},{1034,48},{1034,316},{82,316},{82,317}}, color={0,0,127}));
  connect(conVAVWes.TZonCooSet, TZonSet[4].TZonCooSet) annotation (Line(points=
          {{1238,46},{1232,46},{1232,316},{82,316},{82,317}}, color={0,0,127}));
  annotation (
