...
package BaseClass
  block Controller
    ...
    FaultInjection.Utilities.InsertionTypes.Variables.SignalCorruption.External
      extAtt(faultMode(
        ...
        startTime=0,
        endTime=365*24*3600))
      annotation (Placement(transformation(extent={{32,170},{52,190}})));
    FaultInjection.Utilities.InsertionTypes.Interfaces.RealInput TSupSetALC
      "Supply air temperature setpoint from ALC hardware" annotation (Placement(
          transformation(extent={{-220,360},{-200,380}}), iconTransformation(
            extent={{-220,360},{-200,380}})));
  protected
  ...
  equation
    ...
    connect(extAtt.y, val.TSupSet) annotation (Line(points={{53,180},{66,180},{
            66,-60},{78,-60}}, color={235,0,0}));
    connect(extAtt.y, TSupSet) annotation (Line(points={{53,180},{132.5,180},{
            132.5,180},{220,180}}, color={235,0,0}));
    connect(extAtt.u, supTemSetPoi.TSupSet)
      annotation (Line(points={{30,180},{22,180}}, color={235,0,0}));
    connect(extAtt.uFau, TSupSetALC) annotation (Line(points={{30,186},{26,186},
            {26,320},{-210,320},{-210,370}}, color={235,0,0}));
