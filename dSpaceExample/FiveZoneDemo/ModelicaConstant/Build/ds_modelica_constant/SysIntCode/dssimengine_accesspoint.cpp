...
/* -- Declarations of extern functions. -- */
 ...
 EXTERN_C_DECL void ds_modelica_constant_DSRTInitMdl(
    void);

 EXTERN_C_DECL void ds_modelica_constant_DSRTStartMdl(
    void);

 EXTERN_C_DECL void ds_modelica_constant_DSRTStopMdl(
    void);
...
ds_modelica_constant_DSRTStartMdl();
...
ds_modelica_constant_DSRTStopMdl();
...
pApp->setIoResourceMap(ErrorList, &g_ResourceMap);
    ds_modelica_constant_fcnModule_SIDRoot_TID1 = DsCFcnModule::create(ErrorList, pApp);
ApSimEngineOnInitIoPreRtosInit_ctlcBODY_2_y(ErrorList, pApp);
...
ApSimEngineOnInitIoPostRtosInit_ctlcBODY_0_y(ErrorList);
...
ApSimEngineOnStartIo_ctlcBODY_0_y(ErrorList);
...
ApSimEngineOnStopIo_ctlcBODY_0_y(ErrorList);
...
ApSimEngineRunTimeInit(
    DsTErrorList ErrorList, Int32 calledOnStart) 
{
ApSimEngineRunTimeInit_ctlcBODY_0_y(ErrorList);
if (calledOnStart)
{
}
