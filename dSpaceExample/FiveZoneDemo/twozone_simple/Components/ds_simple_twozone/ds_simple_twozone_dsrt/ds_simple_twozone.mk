...
BUILD_ERROR                    = [sprintf('DSRT MAKE ERROR: Make process failed for model ds_simple_twozone.')]
SYS_TARGET_FILE                = any
PROJ_MARKER_FILE               = no
...
DS_PROTECTION                     = OFF
MW_MAKEFILE                       = ds_simple_twozone.mk
...
# MW_COMPUTER                     = PCWIN64
MW_MODEL                          = ds_simple_twozone
MW_MODEL_MODULES                  = rt_matrx.c rt_printf.c ds_simple_twozone_data.c ds_simple_twozone_dsrtmdlfcn.c ds_simple_twozone_dsrtmf.c ds_simple_twozone_dsrttf.c ds_simple_twozone_dsrtvdf.c rtGetInf.c rtGetNaN.c rt_nonfinite.c dspaceexample_s_dy4854h2b34.c
# MW_MODEL_MODULES_OBJ            = rt_matrx.obj rt_printf.obj ds_simple_twozone_data.obj ds_simple_twozone_dsrtmdlfcn.obj ds_simple_twozone_dsrtmf.obj ds_simple_twozone_dsrttf.obj ds_simple_twozone_dsrtvdf.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj dspaceexample_s_dy4854h2b34.obj 
MW_S_FUNCTIONS                    = 
# MW_S_FUNCTIONS_OBJ              = 
MW_S_FUNCTIONS_LIB                = 
# MW_SOLVER                       = 
...
MASTER_ANCHOR_DIR                 = 
START_DIR                         = D:\github\dspace-modelica-example\dSpaceExample\FiveZoneDemo\twozone_simple\Components\ds_simple_twozone
...
MW_MODELREFS                      = 
MW_MODELREF_LINK_RSPFILE          = ds_simple_twozone_ref.rsp
...
%set DSRT_COMMON_HDR_DIRPATHS += \
    "$(START_DIR)" \
    "$(START_DIR)\ds_simple_twozone_dsrt" \
...
%set LIB_BASENAME = ds_simple_twozone
...
INTERFACE_LIB_$(LIB_BASENAME)_CC_SRC_FILES := ds_simple_twozone.$(MW_TARGET_LANG_EXT) 
