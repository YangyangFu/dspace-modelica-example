...
/* -- Declarations of extern functions. -- */
 ...
 EXTERN_C_DECL void ds_simple_twozone_DSRTInitMdl(
    void);

 EXTERN_C_DECL void ds_simple_twozone_DSRTStartMdl(
    void);

 EXTERN_C_DECL void ds_simple_twozone_DSRTStopMdl(
    void);
...
ds_simple_twozone_DSRTStartMdl();
...
pApp->setIoResourceMap(ErrorList, &g_ResourceMap);
    ds_simple_twozone_fcnModule_SIDRoot_TID1 = DsCFcnModule::create(ErrorList, pApp);
ApSimEngineOnInitIoPreRtosInit_ctlcBODY_2_TRooAir1(ErrorList, pApp);
ApSimEngineOnInitIoPreRtosInit_ctlcBODY_2_TDis1(ErrorList, pApp);
ApSimEngineOnInitIoPreRtosInit_ctlcBODY_2_TDis2(ErrorList, pApp);
ApSimEngineOnInitIoPreRtosInit_ctlcBODY_2_TOut(ErrorList, pApp);
ApSimEngineOnInitIoPreRtosInit_ctlcBODY_2_TRooAir2(ErrorList, pApp);
ApSimEngineOnInitIoPreRtosInit_ctlcBODY_2_VFlo1(ErrorList, pApp);
ApSimEngineOnInitIoPreRtosInit_ctlcBODY_2_VFlo2(ErrorList, pApp);
...
ApSimEngineOnInitIoPostRtosInit_ctlcBODY_0_TRooAir1(ErrorList);
ApSimEngineOnInitIoPostRtosInit_ctlcBODY_0_TDis1(ErrorList);
ApSimEngineOnInitIoPostRtosInit_ctlcBODY_0_TDis2(ErrorList);
ApSimEngineOnInitIoPostRtosInit_ctlcBODY_0_TOut(ErrorList);
ApSimEngineOnInitIoPostRtosInit_ctlcBODY_0_TRooAir2(ErrorList);
ApSimEngineOnInitIoPostRtosInit_ctlcBODY_0_VFlo1(ErrorList);
ApSimEngineOnInitIoPostRtosInit_ctlcBODY_0_VFlo2(ErrorList);
...
ApSimEngineOnStartIo_ctlcBODY_0_TRooAir1(ErrorList);
ApSimEngineOnStartIo_ctlcBODY_0_TDis1(ErrorList);
ApSimEngineOnStartIo_ctlcBODY_0_TDis2(ErrorList);
ApSimEngineOnStartIo_ctlcBODY_0_TOut(ErrorList);
ApSimEngineOnStartIo_ctlcBODY_0_TRooAir2(ErrorList);
ApSimEngineOnStartIo_ctlcBODY_0_VFlo1(ErrorList);
ApSimEngineOnStartIo_ctlcBODY_0_VFlo2(ErrorList);
...
ApSimEngineOnStopIo_ctlcBODY_0_TRooAir1(ErrorList);
ApSimEngineOnStopIo_ctlcBODY_0_TDis1(ErrorList);
ApSimEngineOnStopIo_ctlcBODY_0_TDis2(ErrorList);
ApSimEngineOnStopIo_ctlcBODY_0_TOut(ErrorList);
ApSimEngineOnStopIo_ctlcBODY_0_TRooAir2(ErrorList);
ApSimEngineOnStopIo_ctlcBODY_0_VFlo1(ErrorList);
ApSimEngineOnStopIo_ctlcBODY_0_VFlo2(ErrorList);
...
ApSimEngineRunTimeInit(
    DsTErrorList ErrorList, Int32 calledOnStart) 
{
ApSimEngineRunTimeInit_ctlcBODY_0_TRooAir1(ErrorList);
ApSimEngineRunTimeInit_ctlcBODY_0_TDis1(ErrorList);
ApSimEngineRunTimeInit_ctlcBODY_0_TDis2(ErrorList);
ApSimEngineRunTimeInit_ctlcBODY_0_TOut(ErrorList);
ApSimEngineRunTimeInit_ctlcBODY_0_TRooAir2(ErrorList);
ApSimEngineRunTimeInit_ctlcBODY_0_VFlo1(ErrorList);
ApSimEngineRunTimeInit_ctlcBODY_0_VFlo2(ErrorList);
if (calledOnStart)
{
}
