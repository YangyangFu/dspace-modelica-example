...
BUILD_ERROR                    = [sprintf('DSRT MAKE ERROR: Make process failed for model ds_fivezoneg36_dsrt.')]
SYS_TARGET_FILE                = any
PROJ_MARKER_FILE               = no
...
DS_PROTECTION                     = OFF
MW_MAKEFILE                       = ds_fivezoneg36_dsrt.mk
...
# MW_COMPUTER                     = PCWIN64
MW_MODEL                          = ds_fivezoneg36_dsrt
MW_MODEL_MODULES                  = rt_matrx.c rt_printf.c ds_fivezoneg36_dsrt_data.c ds_fivezoneg36_dsrt_dsrtmdlfcn.c ds_fivezoneg36_dsrt_dsrtmf.c ds_fivezoneg36_dsrt_dsrttf.c ds_fivezoneg36_dsrt_dsrtvdf.c rtGetInf.c rtGetNaN.c rt_nonfinite.c dspaceexample_f_dy975f7hqu.c
# MW_MODEL_MODULES_OBJ            = rt_matrx.obj rt_printf.obj ds_fivezoneg36_dsrt_data.obj ds_fivezoneg36_dsrt_dsrtmdlfcn.obj ds_fivezoneg36_dsrt_dsrtmf.obj ds_fivezoneg36_dsrt_dsrttf.obj ds_fivezoneg36_dsrt_dsrtvdf.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj dspaceexample_f_dy975f7hqu.obj 
MW_S_FUNCTIONS                    = 
# MW_S_FUNCTIONS_OBJ              = 
MW_S_FUNCTIONS_LIB                = 
# MW_SOLVER                       = 
...
MASTER_ANCHOR_DIR                 = 
START_DIR                         = D:\github\dspace-modelica-example\dSpaceExample\FiveZoneDemo\twozone_outputs\Components\ds_fivezoneg36_dsrt
...
MW_MODELREFS                      = 
MW_MODELREF_LINK_RSPFILE          = ds_fivezoneg36_dsrt_ref.rsp
...
%set DSRT_COMMON_HDR_DIRPATHS += \
    "$(START_DIR)" \
    "$(START_DIR)\ds_fivezoneg36_dsrt_dsrt" \
...
%set LIB_BASENAME = ds_fivezoneg36_dsrt
...
INTERFACE_LIB_$(LIB_BASENAME)_CC_SRC_FILES := ds_fivezoneg36_dsrt.$(MW_TARGET_LANG_EXT) 
