...
/* -- Declarations of extern functions. -- */
 ...
 EXTERN_C_DECL void ds_fivezoneg36_DSRTInitMdl(
    void);

 EXTERN_C_DECL void ds_fivezoneg36_DSRTStartMdl(
    void);

 EXTERN_C_DECL void ds_fivezoneg36_DSRTStopMdl(
    void);
...
pApp->setIoResourceMap(ErrorList, &g_ResourceMap);
    ds_fivezoneg36_fcnModule_SIDRoot_TID1 = DsCFcnModule::create(ErrorList, pApp);
